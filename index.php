        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                if ($error) {
                    ...
                    <?php
                    header("refrensh:5;url=index.php"); //5 :detik
                }
                ?>
                <?php
                if ($sukses) {
                ...
                <from action="" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" nama="fakultas" id="fakultas">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td scope="row"><?php echo $nim ?></th>
                                <td scope="row"><?php echo $nama ?></th>
                                <td scope="row"><?php echo $alamat ?></th>
                                <td scope="row"><?php echo $fakultas ?></th>
                                <td scope="row">
