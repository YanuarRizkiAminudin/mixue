...
<nav class="navbar navbar-dark bg-danger">
    ...
    <div class="container">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $sql = "INSERT INTO pesanan (nama,harga_satuan,variant,kuantitas,metode_pembayaran,subtotal) values
		('$nama','$harga_satuan','$variant','$kuantitas','$metode_pembayaran','$subtotal')";
